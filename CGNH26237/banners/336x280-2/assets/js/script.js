...
var timeline = (function MasterTimeline() {
  ...
  function createTimeline() {
    ...
    tl
      ...
      .set(".feed-bottom, .feed-top, .bags, .headline, .cta", { autoAlpha: 0 })
      ...
      .fromTo(".feed-top", { yPercent: -110 , autoAlpha: 1 }, { duration: 0.8, xPercent: 0, yPercent: 0, autoAlpha: 1, ease: "power2.out" }, 0.78)
