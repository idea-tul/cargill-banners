...
var timeline = (function MasterTimeline() {
  ...
  function createTimeline() {
    ...
    tl
      ...
      .set(".feed-bottom, .feed-middle, .feed-top, .bags, .headline, .cta", { autoAlpha: 0 })
      ...
      .to(".headline", { duration: 0.6, autoAlpha: 1, ease: "power2.out" }, 2.54)
      .to(".cta", { duration: 0.5, autoAlpha: 1, ease: "power2.out" }, 2.79)
      .to({}, { duration: 1.0 });
    return tl;
  }
